...
public class CaptureManager {
    ...
    public void initializeFromIntent(Intent intent, Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            beepManager.setBeepEnabled(intent.getBooleanExtra(Intents.Scan.BEEP_ENABLED, false));
            ...
            returnBarcodeImagePath = intent.getBooleanExtra(Intents.Scan.BARCODE_IMAGE_ENABLED, false);
        }
    }
    ...
    public void decodeContinue(BarcodeCallback callback) {
        this.callback = callback;
     ...
     *
     * @param requestCode The request code passed in {@link ActivityCompat#requestPermissions(Activity, String[],
     * int)}.
